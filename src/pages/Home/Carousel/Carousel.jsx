        ...
        <div className="slider-container w-full relative">
            <Slider {...settings} className="absolute">
                <div className="relative md:min-h-screen h-full w-full">
                    ...
                    <div className="absolute md:bottom-16 bottom-5 p-4 bg-opacity-40 w-full">
                        <div className="w-11/12 mx-auto px-4 py-2 bg-opacity-40 rounded">
                            <h2 className="text-6xl font-bold text-gray-200">3E</h2>
                            <p className="text-gray-200 font-medium text-lg">Our pinpoint is 3E because we focus on Environment <br /> Education and  Engineering.</p>
                        </div>
                    </div>
                </div>
                <div className="relative md:min-h-screen h-full w-full">
